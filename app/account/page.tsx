    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-gray-100 via-white to-indigo-100 p-8">
      <div className="flex bg-white shadow-2xl rounded-xl p-6 max-w-4xl w-full border border-gray-300 transform transition-all duration-500 hover:shadow-3xl">
        ...
        <div className="ml-8 flex flex-col justify-center">
          <h1 className="text-5xl font-extrabold text-gray-800 mb-3">My Profile</h1>
          <p className="text-2xl text-gray-700 mb-3">Welcome, <span className="font-semibold">{user.username}</span>!</p>
          <div className="w-full border-t border-gray-300 my-4" />
          <p className="text-xl text-gray-600 mb-2"><strong>Email:</strong> {user.mail}</p>
          <p className="text-xl text-gray-600 mb-2"><strong>Joined on:</strong> {new Date(user.createdAt).toLocaleDateString()}</p>
